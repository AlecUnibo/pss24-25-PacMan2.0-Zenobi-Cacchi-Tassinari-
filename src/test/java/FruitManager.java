//Sostituire questo codice a quello presente nel file FruitManager.java, per testare i timer dello spawn della frutta;
package com.pacman;
...
public class FruitManager {
    ...
    // Reimposta i timer per la gestione dello spawn dei frutti
